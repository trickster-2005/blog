...
This reminded me that disciplinary boundaries are not as natural or as fixed as I once imagined. Computer scientists can have a deep understanding of the humanities and apply it to their research; conversely, an anthropologist can acquire strong programming skills and use them to explore human behavior in new ways.
